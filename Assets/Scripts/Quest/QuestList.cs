...
public class QuestList : MonoBehaviour, ISavable
{
    ...
    public void AddQuest(Quest quest) //Agrega una quest
    {
    ...
    public bool IsStarted(string questName) //Verifica si la quest empezo
    {
    ...
    public bool IsCompleted(string questName) //Verifica si la quest fue completada
    {
        var questStatus = quests.FirstOrDefault(q => q.Base.Name == questName)?.Status;
